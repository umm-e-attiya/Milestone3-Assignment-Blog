...
import photo1 from "../../../public/photo1.jpg"
  ...
  const Itinformation = () =>{
      return (
       <div>
           <div className="mt-9">
            <h1 className="font-bold text-center text-[18px] lg:text-center lg:text-[60px]">Information Technology (IT)</h1>
            </div>

            <div className=" mt-11">
                 <div>
                    <Image src={photo1} alt="photo1" width={500} height={500}   className="ml-4 w-[300px] h-[300px] md:ml-36  md:w-[600px] md:h-[300px] lg:w-[900px] lg:h-[500px] lg:ml-80" />
                 </div>
                <div className=" mt-4 ml-6 md:ml-40 lg:ml-72">
                  ...
                  <p className="w-[300px] mt-2 md:w-[600px] lg:w-[800px] lg:ml-10">The IT department ensures that the organizatios systems, networks, applications, data and information all connect and function properly. The IT team handles the following three major areas:
                    <ul>
